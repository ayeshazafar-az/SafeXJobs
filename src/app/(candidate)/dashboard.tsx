...
export default function CandidateDashboardScreen() {
    const { user } = useAuth();
    const [stats, setStats] = useState({ total: 0, shortlisted: 0, interviews: 0, hired: 0, rejected: 0 });
            ...
            <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
                ...
                <TouchableOpacity style={styles.taskCard}>
                    ...
                    <View style={{ flex: 1 }}>
                        ...
                        <Text style={styles.taskDesc}>No pending skill assessments or assignments generated by employers.</Text>
                    </View>
                    <Ionicons name="arrow-forward" size={20} color="#94a3b8" />
                </TouchableOpacity>
                ...
                <TouchableOpacity style={[styles.taskCard, { opacity: 0.7 }]} onPress={() => router.push('/(candidate)/notifications')}>
                    ...
                    <View style={{ flex: 1 }}>
                        ...
                        <Text style={styles.taskDesc}>All caught up! No recent system alerts regarding your applications.</Text>
                    </View>
                    <Ionicons name="arrow-forward" size={20} color="#94a3b8" />
                </TouchableOpacity>
