        ...
        <KeyboardAvoidingView behavior={Platform.OS === 'ios' ? 'padding' : 'height'} style={styles.container}>
            ...
            <View style={styles.inputArea}>
                <TouchableOpacity style={styles.attachBtn} onPress={handleAttach} disabled={isUploading}>
                    {isUploading ? <ActivityIndicator size="small" color={theme.textSecondary} /> : <Ionicons name="attach" size={24} color={theme.textSecondary} />}
                </TouchableOpacity>
                <TextInput
...
const getStyles = (theme: any) => StyleSheet.create({
    ...
    companyName: { color: theme.text, fontSize: 16, fontWeight: 'bold' },
