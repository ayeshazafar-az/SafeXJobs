                    ...
                    notifications.map(note => (
                        ...
                        >
                            <View style={[styles.iconBox, !note.is_read ? { backgroundColor: 'rgba(59, 130, 246, 0.2)' } : { backgroundColor: '#1e293b' }]}>
                                <Ionicons name={!note.is_read ? "briefcase" : "briefcase-outline"} size={24} color={!note.is_read ? "#38bdf8" : "#64748b"} />
                            </View>
...
const styles = StyleSheet.create({
    ...
    noteCardUnread: { backgroundColor: '#1e293b', borderColor: '#3b82f6' },
    ...
    unreadDot: { width: 10, height: 10, borderRadius: 5, backgroundColor: '#3b82f6', position: 'absolute', top: 20, right: 16 }
});
